...
public class PatientAdd{
	...
	public void patientAdd(){
		...
		idl = new Label("ID :");
		idl.setStyle("-fx-text-fill: #A16946");
		namel = new Label("Name :");
		namel.setStyle("-fx-text-fill: #A16946");
		agel = new Label("Age :");
		agel.setStyle("-fx-text-fill: #A16946");
		diseasel = new Label("Disease :");
		diseasel.setStyle("-fx-text-fill: #A16946");
		billLabel = new Label("Bill :");
		billLabel.setStyle("-fx-text-fill: #A16946");
		genderl = new Label("Gender :");
		genderl.setStyle("-fx-text-fill: #A16946");
		appointmentdatel = new Label("Appointment Date :");
		appointmentdatel.setStyle("-fx-text-fill: #A16946");
		medicinel = new Label("Medicine :");
		medicinel.setStyle("-fx-text-fill: #A16946");
		...
		Image image = new Image("file:world1.png");
		...
		Scene s = new Scene(stack,600,270);
		window.setScene(s);
